...
with open(r'E:\CODING\Floatchat\apps\api\app\demo\offline_demo.py', 'r') as f:
    content = f.read()

# Fix all unquoted keys in JSON-like structures
replacements = [
    (r'(\s+)name: "([^"]*)"', r'\1"name": "\2"'),
...
with open(r'E:\CODING\Floatchat\apps\api\app\demo\offline_demo.py', 'w') as f:
    f.write(content)
